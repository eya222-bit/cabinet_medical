...
CREATE TABLE patient (
                         ...
                         CONSTRAINT fk_patient_username FOREIGN KEY (username) REFERENCES app_user(username) ON DELETE SET NULL
);
...
CREATE TABLE rendez_vous (
                             ...
                             motif VARCHAR(255),
                             CONSTRAINT fk_rdv_patient FOREIGN KEY (id) REFERENCES patient(id) ON DELETE CASCADE,
